(() => {
	...
	function allowDrop(event) {
		...
		if(droppedImage != '' && this.firstChild==null){
    ...
    function resetpuzzipes() {
        for (let zone of dropZones) {
            if(zone.hasChildNodes()){
                var childrenNode = zone.firstChild;
                zone.removeChild(childrenNode);
                document.getElementById('puzzleBoard').appendChild(childrenNode);
            }
        }
    }
